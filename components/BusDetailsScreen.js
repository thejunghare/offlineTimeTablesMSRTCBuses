...
const BusDetailsScreen = ({route}) => {
    ...
    return (
        <View className={"flex-1 bg-white"}>
            <View className={"bg-ezgo-red p-5 flex flex-row items-center justify-between"}>
                <Text className={"text-white font-bold text-base"}>{source} - {destination}</Text>
            ...
            <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', margin: 20}}>
                ...
                <View>
                    <Text className={"bg-green-500 text-white text-bold px-2 rounded"}>4.5</Text>
                </View>
            </View>
            <Divider/>
            <Timeline
