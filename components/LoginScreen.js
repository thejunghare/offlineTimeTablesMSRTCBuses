...
import { Button, Dialog, Portal, Provider, ActivityIndicator } from "react-native-paper";
    ...
    return (
        <Provider>
            <View className="flex-1 items-center justify-center p-4 min-w-full bg-white">
                <View className={"mb-4"}>
                    <Text className={"text-3xl text-start font-bold mb-2"}>Login to EZGO</Text>
                    <Text className={"font-bold text-base text-slate-300"}>Enter your email and password to
                        continue</Text>
                </View>
                ...
                <TouchableOpacity onPress={handleSignup} >
                    <Text className="mb-3 text-end font-bold text-base text-slate-300">Create Account?</Text>
                </TouchableOpacity>
