...
const UnReservedTicketScreen = () => {
      ...
      .then((data) => {
        ...
        if (bus) {
          ...
          if (destinationStop) {
            ...
            const adultFare = destinationStop.fare;
            const womenFare = destinationStop.fare * 0.5; // Assuming 50% of adult fare for women
            const childFare = destinationStop.fare * 0.5; // Assuming 50% of adult fare for children
            const totalFare =
  ...
  const handleAddTicket = () => {
    ...
    if (source === "" || destination === "") {
      showSelectionWarningToast();
    } else {
      if (fare <= 0 || fare === NaN) {
        showFareWarningToast();
      } else {
  ...
  const showSelectionWarningToast = () => {
    Toast.show({
      type: ALERT_TYPE.WARNING,
      title: "Warning",
      textBody: "Please select source and destination",
    });
  };

  const showFareWarningToast = () => {
    Toast.show({
      type: ALERT_TYPE.WARNING,
      title: "Warning",
      textBody: "Not a faild ticket fare",
    });
  };
      ...
      colors={[
        {
          // light theme colors
          label: "black",
          card: "#F5F5F5", // smoke white
          success: "#50C878", // green
          danger: "#C51E3A", //ezgo-red
          warning: "#FFA500", //Saffron Gold
        },
        {
          // dark theme colors
          label: "white",
