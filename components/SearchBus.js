...
const SearchBus = () => {
            ...
            return (
                <View>
                    {buses.map((bus, index) => {
                        ...
                        const destinationTime = destinationIndex !== -1 ? bus.stops[destinationIndex].time : '';
                        ...
                        const destinationTimeParts = destinationIndex !== -1 ? bus.stops[destinationIndex].time.split(':') : [];
                        ...
                        if (destinationHour !== 12 && destinationTimeParts[1]?.includes('PM')) {
                            destinationHour += 12;
                        }
    ...
    return (
        <View className="flex-1 p-4 min-w-full">
            <Text
                className="text-xl subpixel-antialiased	not-italic font-extrabold	tracking-tight leading-relaxed mb-5">
                Search Bus
            </Text>
            <View
                className="  bg-white border border-gray-400 rounded-2xl mb-5 grid grid-cols-1 divide-y divide-gray-400 divide-solid">
                {/* first picker */}
            ...
            <Button
                ...
                className="rounded-3xl p-2 text-base lowercase bg-ezgo-red mb-4"
                dark="true"
                icon="magnify"
                color="white"
            >
